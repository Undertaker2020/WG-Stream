...
export type Mutation = {
  ...
  createSponsorshipPlane: Scalars['Boolean']['output'];
  ...
  removeSponsorshipPlane: Scalars['Boolean']['output'];
...
export type MutationCreateSponsorshipPlaneArgs = {
...
export type MutationRemoveSponsorshipPlaneArgs = {
  planId: Scalars['String']['input'];
};
...
export type FindChannelByUsernameQuery = { __typename?: 'Query', findChannelByUsername: { __typename?: 'UserModel', username: string, email: string, displayName: string, stream: { __typename?: 'StreamModel', title: string } } };
...
export type FindProfileQuery = { __typename?: 'Query', findProfile: { __typename?: 'UserModel', username: string, displayName: string, email: string, avatar?: string | null, bio?: string | null, isTotpEnabled: boolean, notificationSettings: { __typename?: 'NotificationSettingsModel', siteNotifications: boolean, telegramNotifications: boolean } } };
